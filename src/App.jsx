...
export function App() {
  ...
  const [restaurant, setResturant] = React.useState(null);
  ...
  //data.filter(data => data.food_category == category && data.restaurant == restaurant);
  return (
    <main className="App">
      {/* CATEGORIES COLUMN */}
      ...
      <div className="container">
        ...
        <div className="RestaurantsRow">
          ...
          <Chip
           ...
           onClick={() => setResturant(restaurants)}
           /> 
          ))}
          </div>
        </div>
